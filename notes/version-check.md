...
| SQLAlchemy / Psycopg / Redis | 已安装实测基础路径；P9 历史候选完成 Docker 服务集成 | SQLAlchemy 2.0.51、Psycopg 3.3.4、Redis client 8.0.1；历史容器证据见 `notes/p9-project-runtime-qa.md`，本轮新增租约心跳、运行中取消与 DLQ 批准机制尚未在 Compose 中重新验证 |
