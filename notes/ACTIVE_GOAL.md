...
- P5—P8 的培训、引用、图形版式和 GitHub 展示仓库内范围已经完成；当前 P9 候选为 236 张图、453 页固定字体 PDF 和 EPUB3。
- P9 已完成当前源码十项目 CLI/容器运行、全新 Python 3.12 环境、252 项测试、三格式出版、发行资产/外链/密钥/隐私审计和三类维护者角色复审。
...
- 上述外部门禁已有统一执行包、匿名 YAML 模板和机器验收器；它们提高证据可执行性，但不冒充七份真实外部记录。
