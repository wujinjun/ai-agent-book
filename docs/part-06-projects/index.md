...
本篇把前五篇的横向能力组合成十个递进项目。进入本篇前，读者至少应完成第8、9、13、23、24、28—30章；每个项目将同时说明需求、架构、数据流、关键代码、失败路径、部署与扩展，而 README 继续承担安装和运行说明。
...
项目10的完整企业平台部署拓扑放在项目10章节中，不在项目1之前提前展开。完成本篇后，读者应至少交付一个可演示项目、一份架构 ADR、一组失败证据和一份部署说明；第七篇再讨论能力进一步扩大时的架构与产品边界。
