...
![图像音频视频和复杂文档分别经过 OCR 转写帧采样与版面解析，保留来源页码区域时间戳形成统一证据对象，再进入检索关联推断工具和未知边界，最后完成引用人审脱敏成本与质量评估](../assets/infographics/png/multimodal-evidence-infographic-2x.png)

*图 35-A　多模态证据对象与时间完整性。*
