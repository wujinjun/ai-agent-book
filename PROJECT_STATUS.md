...
- P7 历史基线已完成仓库内范围；当时共 240 张 Mermaid 图，均统一图号与出版资产，过密图已修订，项目 10 真实离线 Trace 截图可复现。HTML 三视口、固定字体 PDF、Apple Books 和 Calibre 均有人工或引擎验收记录；此后新增源码图需在下一出版候选重新生成资产。
