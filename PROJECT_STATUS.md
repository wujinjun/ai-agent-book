...
- 全仓库共有 218 张 Mermaid 图，已经生成 SVG、2x PNG 和内容哈希清单；HTML、PDF 和 EPUB 使用预渲染资产，不依赖阅读器现场执行 Mermaid。
- MkDocs HTML 严格构建、断链、缺图、alt、重复 ID 和残留 Mermaid 自动审计已建立。
- PDF 当前为 386 页 A4、11,446,236 字节，封面、目录、章节、代码、图示、项目、术语表与参考资料通过自动出版审计。
- EPUB3 为 12,071,391 字节，包含 217 张正文 SVG 与 217 张 PNG 回退，具备 nav、spine、严格 XHTML 与资源引用检查。
...
2026-08-06 在 Python 3.12.13 下重新运行 Ruff、mypy、根测试与十项目测试，113 项通过；重建 218 组图示资产、MkDocs HTML、PDF 和 EPUB，自动出版审计通过。当前 PDF 为 386 页、11,446,236 字节，EPUB 为 12,071,391 字节。出版产物的最终发行仍以 P7 和 P9 的人工验收为准。
