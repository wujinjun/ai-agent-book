...
“出版预览版”不等于商业出版终稿，也不等于十个项目均可直接投入生产。外部 Provider 联调、真实班级试讲、正式引用、人工编辑、多设备版式验收和项目生产环境验证仍在质量路线图中跟踪。
...
2026-08-08 在 Python 3.12.13 下重新运行 Ruff、mypy 和 214 项根级测试；独立示例、框架候选与企业培训门禁全部通过。十项目服务契约、项目 4 版本化发布、项目 8 持久重放、项目 10 认证/DLQ/备份路径及两套 Compose 配置已验证，重建 235 组图示资产。公开 v2026.8.0 的 HTML、400 页 PDF 和 EPUB3 已通过上一轮自动审计；包含培训版的新出版物将在 P6—P7 编辑后统一重建。最终多设备发行验收仍以 P7 和 P9 为准。
