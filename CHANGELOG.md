...
- 完成出版信息图升级：A 级核心图 12/12、B 级增强图 20/20；本轮内容与项目增强后保留 240 张 Mermaid 作为 C 级精确工程图。
...
- 重新构建并验收 MkDocs HTML、517 页 A4 PDF 与 EPUB3；Ruff、269 项测试、严格文档构建、出版、隐私、仓库卫生和视觉审计通过。
